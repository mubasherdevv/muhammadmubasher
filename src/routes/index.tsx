              ...
              {[
                {
                  ...
                  title: "Modern React & Next.js Web Apps",
                  desc: "Building fast, interactive websites and web applications with clean TypeScript, Tailwind CSS styling, and responsive layouts that work seamlessly across all screen sizes.",
                  bullets: [
                    "Next.js & React ecosystem",
                    "Tailwind CSS responsive design",
                    "Smooth Framer Motion animations",
                  ],
                  highlight: "Fast, Clean & Responsive UI",
                },
                {
                  icon: Smartphone,
                  tag: "Mobile Development",
                  title: "React Native & Expo Apps",
                  desc: "Developing smooth mobile apps with React Native and Expo Router, featuring modern glassmorphic interfaces, offline data caching, and ready-to-test APK builds.",
                  bullets: [
                    "React Native & Expo Router",
                    "Offline caching with React Query",
                    "Fast APK builds & smooth interactions",
                  ],
                  highlight: "Smooth Mobile Experience",
                },
                {
                  icon: Server,
                  tag: "Backend & Database",
                  title: "Node.js & Supabase Integration",
                  desc: "Connecting your apps with scalable backend services, secure authentication, PostgreSQL database schemas, and REST APIs for realtime data synchronization.",
                  bullets: [
                    "Supabase & PostgreSQL database",
                    "Secure user login & auth flows",
                    "REST APIs & realtime data sync",
                  ],
                  highlight: "Complete Backend & Auth Setup",
                },
                {
                  icon: Layers,
                  tag: "Full-Stack Workflow",
                  title: "Clean Code & Fast Turnaround",
                  desc: "Direct 1-on-1 collaboration without confusing middlemen. Delivering clean, well-structured TypeScript code with frequent updates and quick turnaround times.",
                  bullets: [
                    "Direct developer communication",
                    "Clean, typed TypeScript codebase",
                    "Regular demo updates & support",
                  ],
                  highlight: "Direct Collaboration & Support",
                },
              ].map((item, i) => (
                <motion.div
                  key={item.title}
